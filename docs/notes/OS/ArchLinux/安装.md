...
![fastfetch](http://picbed.l0v3ch4n.top/blog/OS/ArchLinux/installation/fastfetch.jpg)
...
3. 硬盘分区、格式化
   ...
   ![lsblk](http://picbed.l0v3ch4n.top/blog/OS/ArchLinux/installation/lsblk.png)
