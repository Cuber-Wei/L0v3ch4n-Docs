---
url: /language/Shell/Basic/index.md
---
## Hello World
...
```
hello, L0v3ch4n ! hello, L0v3ch4n !
hello, L0v3ch4n ! hello, ${your_name} !
```
...
```bash
string="L0v3ch4n is a great site"
...
> * 在 MAC 中的 `expr` 语法是：`$((表达式))`，此处表达式中的 `*` 不需要转义符号 `\` 。
